...
python3 train.py --train_space='polar' --time_sampling='power_law' --batch_size=20 --num_epochs=2 --n_samples=5000 --n_layers=2 --n_train_samples=100 --n_samples=100 --output_path=${OUTPUT_PATH} --n_viz_samples=100 --integration_steps=4 --num_particles=30 --jet_types g